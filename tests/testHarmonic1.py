...
from utils import Harmonic as har
...
# 计算时间
Ts, Tj, Ta, Tv, jm = har.calculate_Tall(D, Sm, Vm, Am, Jm)
...
# 计算对应的时间段
tk = har.calculate_t(Ts, Tj, Ta, Tv)

# 生成jerk曲线
jerk = copysign(1, D) * har.calculate_jerk(t, tk, jerk, Jm)
